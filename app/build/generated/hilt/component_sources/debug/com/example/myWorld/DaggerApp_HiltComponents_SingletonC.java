...
import com.example.presentation.viewModel.HomeViewModel_HiltModules_KeyModule_Provide_LazyMapKey;
...
public final class DaggerApp_HiltComponents_SingletonC {
  ...
  private static final class SingletonCImpl extends App_HiltComponents.SingletonC {
    ...
    private RoomDao roomDao() {
      return RoomModule_ProvideExampleDaoFactory.provideExampleDao(provideDatabaseProvider.get());
    }

    private RoomRepository roomRepository() {
      return RoomModule_ProvideExampleRepositoryFactory.provideExampleRepository(roomDao());
    }
