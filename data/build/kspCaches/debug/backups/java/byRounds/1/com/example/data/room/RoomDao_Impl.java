...
public final class RoomDao_Impl implements RoomDao {
  ...
  public RoomDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfRoomEntity = new EntityInsertionAdapter<RoomEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `user_table` (`id`,`name`,`age`) VALUES (nullif(?, 0),?,?)";
      }
  ...
  @Override
  public Object insert(final RoomEntity user, final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      ...
      public Unit call() throws Exception {
        ...
        try {
          __insertionAdapterOfRoomEntity.insert(user);
  ...
  @Override
  public Object getUserById(final int userId, final Continuation<? super RoomEntity> $completion) {
      ...
      public RoomEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new RoomEntity(_tmpId,_tmpName,_tmpAge);
          } else {
            _result = null;
          }
          return _result;
